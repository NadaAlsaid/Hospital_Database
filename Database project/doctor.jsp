...
<report name="doctor" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="DOCTOR" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="DOCTOR">
      <select>
      <![CDATA[select FIRST_NAME FIRST_NAME, MINIT_NAME MINIT_NAME, LAST_NAME LAST_NAME, SEX SEX, HIRE_DATE HIRE_DATE, SALARY SALARY, SSN SSN, ADDRES ADDRES, EMAIL EMAIL, PHONE PHONE, D_ID D_ID, DEP_ID DEP_ID from DOCTOR]]>
      </select>
      ...
      <group name="G_FIRST_NAME">
        ...
        <dataItem name="FIRST_NAME" datatype="vchar2" columnOrder="11"
         ...
         columnFlags="33" defaultLabel="First Name">
          <dataDescriptor expression="FIRST_NAME"
           descriptiveExpression="FIRST_NAME" order="1" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="MINIT_NAME" datatype="vchar2" columnOrder="12"
         width="30" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Minit Name">
          <dataDescriptor expression="MINIT_NAME"
           descriptiveExpression="MINIT_NAME" order="2" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="LAST_NAME" datatype="vchar2" columnOrder="13"
         ...
         columnFlags="33" defaultLabel="Last Name">
          <dataDescriptor expression="LAST_NAME"
           descriptiveExpression="LAST_NAME" order="3" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="HIRE_DATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Hire Date">
          <dataDescriptor expression="HIRE_DATE"
           descriptiveExpression="HIRE_DATE" order="5" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SALARY" oracleDatatype="number" columnOrder="16"
         ...
         columnFlags="33" defaultLabel="Salary">
          <dataDescriptor expression="SALARY" descriptiveExpression="SALARY"
           order="6" width="22" precision="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SSN" oracleDatatype="number" columnOrder="17"
         ...
         columnFlags="33" defaultLabel="Ssn">
          <dataDescriptor expression="SSN" descriptiveExpression="SSN"
           order="7" width="22" precision="19"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="D_ID" oracleDatatype="number" columnOrder="21"
         width="22" defaultWidth="90000" defaultHeight="10000"
         columnFlags="33" defaultLabel="D Id">
          <dataDescriptor expression="D_ID" descriptiveExpression="D_ID"
           order="11" width="22" precision="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DEP_ID" oracleDatatype="number" columnOrder="22"
         width="22" defaultWidth="90000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Dep Id">
          <dataDescriptor expression="DEP_ID" descriptiveExpression="DEP_ID"
           order="12" width="22" precision="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="EMAIL" datatype="vchar2" columnOrder="19" width="40"
        ...
        <dataItem name="SEX" datatype="vchar2" columnOrder="14" width="15"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Sex">
          <dataDescriptor expression="SEX" descriptiveExpression="SEX"
           order="4" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="ADDRES" datatype="vchar2" columnOrder="18" width="30"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Addres">
          <dataDescriptor expression="ADDRES" descriptiveExpression="ADDRES"
           order="8" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="PHONE" oracleDatatype="number" columnOrder="20"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Phone">
          <dataDescriptor expression="PHONE" descriptiveExpression="PHONE"
           order="10" width="22" precision="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
  ...
  <section name="main">
    <body>
      <frame name="M_G_FIRST_NAME_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="7.43750" height="0.68750"
        />
         ...
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_FIRST_NAME" source="FIRST_NAME" minWidowLines="1"
           spacing="0" alignment="start">
            ...
            <geometryInfo x="0.00000" y="0.12500" width="0.56250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_MINIT_NAME" source="MINIT_NAME" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
          ...
          <field name="F_HIRE_DATE" source="HIRE_DATE" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="1.62500" y="0.12500" width="1.00000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_SALARY" source="SALARY" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="2.62500" y="0.12500" width="1.31250"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_SSN" source="SSN" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="3.93750" y="0.12500" width="1.00000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_D_ID" source="D_ID" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="4.93750" y="0.12500" width="1.00000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_DEP_ID" source="DEP_ID" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="5.93750" y="0.12500" width="1.00000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_EMAIL" source="EMAIL" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="7"/>
            <geometryInfo x="6.93750" y="0.12500" width="0.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_FIRST_NAME_FTR">
          ...
          <field name="F_AvgSALARYPerReport" source="AvgSALARYPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            ...
            <geometryInfo x="2.62500" y="0.31250" width="1.31250"
             height="0.12500"/>
            <generalLayout verticalElasticity="expand"/>
          ...
          <field name="F_MinSALARYPerReport" source="MinSALARYPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="7" bold="yes"/>
            <geometryInfo x="2.62500" y="0.43750" width="1.31250"
             height="0.12500"/>
            <generalLayout verticalElasticity="expand"/>
            <visualSettings fillBackgroundColor="Totals"/>
          </field>
          <field name="F_MaxSALARYPerReport" source="MaxSALARYPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="7" bold="yes"/>
            <geometryInfo x="2.62500" y="0.56250" width="1.31250"
             height="0.12500"/>
            <generalLayout verticalElasticity="expand"/>
            <visualSettings fillBackgroundColor="Totals"/>
          </field>
          ...
          <text name="B_Minimum_" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.00000" y="0.43750" width="0.50000"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="Totals"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes"/>
        ...
        <frame name="M_G_FIRST_NAME_HDR">
          ...
          <text name="B_MINIT_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <text name="B_LAST_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.12500" y="0.00000" width="0.50000"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes" textColor="TextColor"
          ...
          <text name="B_HIRE_DATE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.62500" y="0.00000" width="1.00000"
             height="0.12500"/>
          ...
          <text name="B_SALARY" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.62500" y="0.00000" width="1.31250"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes" textColor="TextColor"
          ...
          <text name="B_SSN" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.93750" y="0.00000" width="1.00000"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes" textColor="TextColor"
          ...
          <text name="B_D_ID" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.93750" y="0.00000" width="1.00000"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes" textColor="TextColor"
          ...
          <text name="B_DEP_ID" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="5.93750" y="0.00000" width="1.00000"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes" textColor="TextColor"
          ...
          <text name="B_EMAIL" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="6.93750" y="0.00000" width="0.50000"
             height="0.12500"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="7" bold="yes" textColor="TextColor"
...
<rw:dataArea id="MGFIRSTNAMEGRPFR229">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBFIRSTNAME229" asArray="no"/> class="OraColumnHeader"> First Name </th>
   <th <rw:id id="HBMINITNAME229" asArray="no"/> class="OraColumnHeader"> Minit Name </th>
   <th <rw:id id="HBLASTNAME229" asArray="no"/> class="OraColumnHeader"> Last Name </th>
   <th <rw:id id="HBHIREDATE229" asArray="no"/> class="OraColumnHeader"> Hire Date </th>
   <th <rw:id id="HBSALARY229" asArray="no"/> class="OraColumnHeader"> Salary </th>
   <th <rw:id id="HBSSN229" asArray="no"/> class="OraColumnHeader"> Ssn </th>
   <th <rw:id id="HBDID229" asArray="no"/> class="OraColumnHeader"> D Id </th>
   <th <rw:id id="HBDEPID229" asArray="no"/> class="OraColumnHeader"> Dep Id </th>
   <th <rw:id id="HBEMAIL229" asArray="no"/> class="OraColumnHeader"> Email </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGFIRSTNAME2291" src="G_FIRST_NAME">
   <tr>
    <td <rw:headers id="HFFIRSTNAME229" src="HBFIRSTNAME229"/> class="OraCellText"><rw:field id="FFIRSTNAME229" src="FIRST_NAME" nullValue="&nbsp;"> F_FIRST_NAME </rw:field></td>
    <td <rw:headers id="HFMINITNAME229" src="HBMINITNAME229"/> class="OraCellText"><rw:field id="FMINITNAME229" src="MINIT_NAME" nullValue="&nbsp;"> F_MINIT_NAME </rw:field></td>
    <td <rw:headers id="HFLASTNAME229" src="HBLASTNAME229"/> class="OraCellText"><rw:field id="FLASTNAME229" src="LAST_NAME" nullValue="&nbsp;"> F_LAST_NAME </rw:field></td>
    <td <rw:headers id="HFHIREDATE229" src="HBHIREDATE229"/> class="OraCellText"><rw:field id="FHIREDATE229" src="HIRE_DATE" nullValue="&nbsp;"> F_HIRE_DATE </rw:field></td>
    <td <rw:headers id="HFSALARY229" src="HBSALARY229"/> class="OraCellNumber"><rw:field id="FSALARY229" src="SALARY" nullValue="&nbsp;"> F_SALARY </rw:field></td>
    <td <rw:headers id="HFSSN229" src="HBSSN229"/> class="OraCellNumber"><rw:field id="FSSN229" src="SSN" nullValue="&nbsp;"> F_SSN </rw:field></td>
    <td <rw:headers id="HFDID229" src="HBDID229"/> class="OraCellNumber"><rw:field id="FDID229" src="D_ID" nullValue="&nbsp;"> F_D_ID </rw:field></td>
    <td <rw:headers id="HFDEPID229" src="HBDEPID229"/> class="OraCellNumber"><rw:field id="FDEPID229" src="DEP_ID" nullValue="&nbsp;"> F_DEP_ID </rw:field></td>
    <td <rw:headers id="HFEMAIL229" src="HBEMAIL229"/> class="OraCellText"><rw:field id="FEMAIL229" src="EMAIL" nullValue="&nbsp;"> F_EMAIL </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 ...
 <tr>
  ...
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFAvgSALARYPerReport229" src="HBSALARY229"/> class="OraTotalNumber">Average: <rw:field id="FAvgSALARYPerReport229" src="AvgSALARYPerReport" nullValue="&nbsp;"> F_AvgSALARYPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
 ...
 <tr>
  ...
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFMinSALARYPerReport229" src="HBSALARY229"/> class="OraTotalNumber">Minimum: <rw:field id="FMinSALARYPerReport229" src="MinSALARYPerReport" nullValue="&nbsp;"> F_MinSALARYPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
 ...
 <tr>
  ...
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFMaxSALARYPerReport229" src="HBSALARY229"/> class="OraTotalNumber">Maximum: <rw:field id="FMaxSALARYPerReport229" src="MaxSALARYPerReport" nullValue="&nbsp;"> F_MaxSALARYPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
