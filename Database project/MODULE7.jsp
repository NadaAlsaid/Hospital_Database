...
<report name="DOCTORS" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="DOCTORS" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <userParameter name="P_2" datatype="number" width="40" defaultWidth="0"
     defaultHeight="0">
      <listOfValues restrictToList="yes">
        <selectStatement hideFirstColumn="no">
        <![CDATA[SELECT ALL DEPARTMENT.DEP_ID
FROM DEPARTMENT ]]>
        </selectStatement>
      </listOfValues>
    </userParameter>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL DEPARTMENT.TYPE_DEPARTMENT,DEPARTMENT.DEP_ID, DOCTOR.FIRST_NAME, 
 DOCTOR.LAST_NAME, DOCTOR.HIRE_DATE, DOCTOR.SALARY, DOCTOR.D_ID
FROM DEPARTMENT, DOCTOR
where ((DEPARTMENT.DEP_ID= :P_2 ) AND ( DEPARTMENT.DEP_ID =DOCTOR.DEP_ID))]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_TYPE_DEPARTMENT">
        <displayInfo x="0.60828" y="1.94995" width="2.78357" height="0.94336"
        />
        <dataItem name="TYPE_DEPARTMENT" datatype="vchar2" columnOrder="12"
         width="30" defaultWidth="100000" defaultHeight="10000"
         columnFlags="1" defaultLabel="Type Department">
          <dataDescriptor expression="DEPARTMENT.TYPE_DEPARTMENT"
           descriptiveExpression="TYPE_DEPARTMENT" order="1" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DEP_ID" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Dep Id">
          <dataDescriptor expression="DEPARTMENT.DEP_ID"
           descriptiveExpression="DEP_ID" order="2" oracleDatatype="number"
           width="22" precision="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <summary name="SumSALARYPerTYPE_DEPARTMENT" source="SALARY"
         function="sum" width="22" precision="10" reset="G_TYPE_DEPARTMENT"
      ...
      <group name="G_DEP_ID">
        <displayInfo x="1.30408" y="3.49951" width="1.39197" height="1.28516"
        />
        <dataItem name="FIRST_NAME" datatype="vchar2" columnOrder="14"
         width="30" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="First Name">
          <dataDescriptor expression="DOCTOR.FIRST_NAME"
           descriptiveExpression="FIRST_NAME" order="3" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="LAST_NAME" datatype="vchar2" columnOrder="15"
         width="30" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Last Name">
          <dataDescriptor expression="DOCTOR.LAST_NAME"
           descriptiveExpression="LAST_NAME" order="4" width="30"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="HIRE_DATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Hire Date">
          <dataDescriptor expression="DOCTOR.HIRE_DATE"
           descriptiveExpression="HIRE_DATE" order="5" oracleDatatype="date"
           width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SALARY" oracleDatatype="number" columnOrder="17"
         ...
         columnFlags="33" defaultLabel="Salary">
          <dataDescriptor expression="DOCTOR.SALARY"
           descriptiveExpression="SALARY" order="6" oracleDatatype="number"
           width="22" precision="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="D_ID" oracleDatatype="number" columnOrder="18"
         width="22" defaultWidth="90000" defaultHeight="10000"
         columnFlags="33" defaultLabel="D Id">
          <dataDescriptor expression="DOCTOR.D_ID"
           descriptiveExpression="D_ID" order="7" oracleDatatype="number"
           width="22" precision="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="CountDEP_IDPerReport" source="DEP_ID" function="count"
    ...
    <summary name="SumSALARYPerReport" source="SALARY" function="sum"
     ...
     defaultLabel="Total:">
      <displayInfo x="0.77905" y="0.00000" width="0.79993" height="0.19995"/>
    </summary>
  </data>
  <layout>
  <section name="main">
    <body>
      <frame name="M_G_TYPE_DEPARTMENT_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="7.43750" height="0.75000"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"/>
        <repeatingFrame name="R_G_TYPE_DEPARTMENT" source="G_TYPE_DEPARTMENT"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <frame name="M_G_DEP_ID_GRPFR">
            <geometryInfo x="2.37500" y="0.18750" width="5.06250"
             height="0.18750"/>
            <generalLayout verticalElasticity="variable"/>
            <visualSettings fillPattern="transparent"/>
            <repeatingFrame name="R_G_DEP_ID" source="G_DEP_ID"
             printDirection="down" minWidowRecords="1" columnMode="no">
              <geometryInfo x="2.37500" y="0.18750" width="5.06250"
               height="0.18750"/>
              ...
              <field name="F_FIRST_NAME" source="FIRST_NAME" minWidowLines="1"
               spacing="0" alignment="start">
                ...
                <geometryInfo x="2.37500" y="0.18750" width="0.75000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_LAST_NAME" source="LAST_NAME" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="8"/>
                <geometryInfo x="3.12500" y="0.18750" width="0.75000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_HIRE_DATE" source="HIRE_DATE" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="8"/>
                <geometryInfo x="3.87500" y="0.18750" width="1.06250"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_SALARY" source="SALARY" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="8"/>
                <geometryInfo x="4.93750" y="0.18750" width="1.43750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_D_ID" source="D_ID" minWidowLines="1" spacing="0"
               alignment="start">
                <font face="helvetica" size="8"/>
          ...
          <field name="F_TYPE_DEPARTMENT" source="TYPE_DEPARTMENT"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="8" bold="yes"
             textColor="TableHeading"/>
          ...
          <field name="F_DEP_ID" source="DEP_ID" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="8"/>
        ...
        <frame name="M_G_TYPE_DEPARTMENT_FTR">
          ...
          <field name="F_CountDEP_IDPerReport" source="CountDEP_IDPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="8" bold="yes" textColor="TextColor"/>
            <geometryInfo x="1.18750" y="0.56250" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_SumSALARYPerReport" source="SumSALARYPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="8" bold="yes" textColor="TextColor"/>
            <geometryInfo x="4.93750" y="0.37500" width="1.43750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        ...
        <frame name="M_G_TYPE_DEPARTMENT_HDR">
          ...
          <text name="B_TYPE_DEPARTMENT" minWidowLines="1">
            <textSettings spacing="0"/>
            ...
            <textSegment>
              ...
              <string>
              <![CDATA[Type Department]]>
              </string>
            </textSegment>
          </text>
          <text name="B_DEP_ID" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <text name="B_FIRST_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.37500" y="0.00000" width="0.75000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="8" bold="yes" textColor="white"/>
          ...
          <text name="B_LAST_NAME" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.12500" y="0.00000" width="0.75000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="8" bold="yes" textColor="white"/>
          ...
          <text name="B_HIRE_DATE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.87500" y="0.00000" width="1.06250"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="8" bold="yes" textColor="white"/>
          ...
          <text name="B_SALARY" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.93750" y="0.00000" width="1.43750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="8" bold="yes" textColor="white"/>
          ...
          <text name="B_D_ID" minWidowLines="1">
            <textSettings spacing="0"/>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
  ...
  <parameterForm>
  <roundedRectangle name="PB_1" pageNumber="1">
    <geometryInfo x="0.23962" y="0.22913" width="3.25000" height="0.91675"/>
    <visualSettings fillPattern="transparent" fillBackgroundColor="r25g50b75"
     linePattern="solid"/>
    <points>
      <point x="0.23962" y="0.22913"/>
      <point x="3.25000" y="0.91675"/>
      <point x="0.13794" y="0.13794"/>
    </points>
  </roundedRectangle>
  <text name="PB_2" pageNumber="1" minWidowLines="1">
    <textSettings justify="center" spacing="single"/>
    <geometryInfo x="0.41663" y="0.38538" width="2.77087" height="0.28125"/>
    <visualSettings fillBackgroundColor="r25g75b75"/>
    <textSegment>
      <font face="Courier New" size="18" bold="yes"/>
      <string>
      <![CDATA[ENTER DEPARTMENT ID]]>
      </string>
    </textSegment>
  </text>
  <text name="PB_3" pageNumber="1" minWidowLines="1">
    <textSettings justify="center" spacing="single"/>
    <geometryInfo x="0.32288" y="1.62500" width="1.21875" height="0.27087"/>
    <visualSettings fillBackgroundColor="r25g50b75"/>
    <textSegment>
      <font face="Courier New" size="10" textColor="r25g0b50"/>
      <string>
      <![CDATA[DEPARTMENT ID]]>
      </string>
    </textSegment>
  </text>
  <field name="PF_1" source="P_2" pageNumber="1" minWidowLines="1" spacing="0"
   alignment="start">
    <font size="0"/>
    <geometryInfo x="1.83337" y="1.61462" width="1.70825" height="0.25000"/>
...
<rw:dataArea id="MGTYPEDEPARTMENTGRPFR172">
<table class="OraTable">
<caption>  </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBTYPEDEPARTMENT172" asArray="no"/> class="OraColumnHeader"> Type Department </th>
   <th <rw:id id="HBDEPID172" asArray="no"/> class="OraColumnHeader"> Dep Id </th>
   <th <rw:id id="HBFIRSTNAME172" asArray="no"/> class="OraColumnHeader"> First Name </th>
   <th <rw:id id="HBLASTNAME172" asArray="no"/> class="OraColumnHeader"> Last Name </th>
   <th <rw:id id="HBHIREDATE172" asArray="no"/> class="OraColumnHeader"> Hire Date </th>
   <th <rw:id id="HBSALARY172" asArray="no"/> class="OraColumnHeader"> Salary </th>
   <th <rw:id id="HBDID172" asArray="no"/> class="OraColumnHeader"> D Id </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGTYPEDEPARTMENT1721" src="G_TYPE_DEPARTMENT">
   <rw:foreach id="RGDEPID1721" src="G_DEP_ID">
    <tr>
     <td <rw:id id="HFTYPEDEPARTMENT172" breakLevel="RGTYPEDEPARTMENT1721" asArray="no"/> class="OraRowHeader"><rw:field id="FTYPEDEPARTMENT172" src="TYPE_DEPARTMENT" breakLevel="RGTYPEDEPARTMENT1721" breakValue="&nbsp;"> F_TYPE_DEPARTMENT </rw:field></td>
     <td <rw:id id="HFDEPID172" breakLevel="RGTYPEDEPARTMENT1721" asArray="no"/> class="OraRowHeader"><rw:field id="FDEPID172" src="DEP_ID" breakLevel="RGTYPEDEPARTMENT1721" breakValue="&nbsp;"> F_DEP_ID </rw:field></td>
     <td <rw:headers id="HFFIRSTNAME172" src="HBFIRSTNAME172, HBTYPEDEPARTMENT172, HFTYPEDEPARTMENT172, HBDEPID172, HFDEPID172"/> class="OraCellText"><rw:field id="FFIRSTNAME172" src="FIRST_NAME" nullValue="&nbsp;"> F_FIRST_NAME </rw:field></td>
     <td <rw:headers id="HFLASTNAME172" src="HBLASTNAME172, HBTYPEDEPARTMENT172, HFTYPEDEPARTMENT172, HBDEPID172, HFDEPID172"/> class="OraCellText"><rw:field id="FLASTNAME172" src="LAST_NAME" nullValue="&nbsp;"> F_LAST_NAME </rw:field></td>
     <td <rw:headers id="HFHIREDATE172" src="HBHIREDATE172, HBTYPEDEPARTMENT172, HFTYPEDEPARTMENT172, HBDEPID172, HFDEPID172"/> class="OraCellText"><rw:field id="FHIREDATE172" src="HIRE_DATE" nullValue="&nbsp;"> F_HIRE_DATE </rw:field></td>
     <td <rw:headers id="HFSALARY172" src="HBSALARY172, HBTYPEDEPARTMENT172, HFTYPEDEPARTMENT172, HBDEPID172, HFDEPID172"/> class="OraCellNumber"><rw:field id="FSALARY172" src="SALARY" nullValue="&nbsp;"> F_SALARY </rw:field></td>
     <td <rw:headers id="HFDID172" src="HBDID172, HBTYPEDEPARTMENT172, HFTYPEDEPARTMENT172, HBDEPID172, HFDEPID172"/> class="OraCellNumber"><rw:field id="FDID172" src="D_ID" nullValue="&nbsp;"> F_D_ID </rw:field></td>
    </tr>
   </rw:foreach>
  </rw:foreach>
 </tbody>
 ...
 <tr>
  ...
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFSumSALARYPerReport172" src="HBSALARY172"/> class="OraTotalNumber">Total: <rw:field id="FSumSALARYPerReport172" src="SumSALARYPerReport" nullValue="&nbsp;"> F_SumSALARYPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
 </tr>
 <tr>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFCountDEPIDPerReport172" src="HBDEPID172"/> class="OraTotalNumber">Count: <rw:field id="FCountDEPIDPerReport172" src="CountDEP_IDPerReport" nullValue="&nbsp;"> F_CountDEP_IDPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
