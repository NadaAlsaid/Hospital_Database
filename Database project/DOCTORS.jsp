...
where ((DEPARTMENT.DEP_ID= :P_2 ) AND ( DEPARTMENT.DEP_ID =DOCTOR.DEP_ID))]]>
      ...
      <group name="G_TYPE_DEPARTMENT">
        ...
        />
        <dataItem name="TYPE_DEPARTMENT" datatype="vchar2" columnOrder="11"
        ...
        <dataItem name="DEP_ID" oracleDatatype="number" columnOrder="12"
      ...
      <group name="G_DEP_ID">
        ...
        <dataItem name="D_ID" oracleDatatype="number" columnOrder="17"
